    ...
    async def get_nearby_fact(
        ...
        try:
            system_prompt = (
                ...
                "• Опирайтесь на общеизвестные исторические факты и географические особенности\n"
                "• Предпочитайте проверенную информацию спорным или малоизвестным деталям\n"
                "• Используйте приблизительные временные рамки если не помните точных дат\n"
                "• Лучше дать интересный факт в общих чертах, чем отказаться полностью\n"
                "• ВСЕГДА находите что-то интересное для рассказа\n\n"
            ...
            if is_live_location:
                ...
                user_prompt = (
                    ...
                    "💎 ПОДХОД К ФАКТАМ:\n"
                    "• Рассказывайте о том, что хорошо известно и проверено\n"
                    "• Исторические факты излагайте в общих чертах, избегая спорных деталей\n"
                    "• Приблизительные даты лучше сомнительных точных\n"
                    "• ВСЕГДА предоставляйте интересный факт — отказ недопустим\n\n"
                    "ЦЕЛЬ: Создайте ПОДРОБНЫЙ и РАЗВЕРНУТЫЙ факт (примерно 100-120 слов). Включите:\n"
                ...
                user_prompt = (
                    ...
                    "• Опирайтесь на общеизвестную информацию\n"
                    "• ВСЕГДА предоставляйте интересный факт\n\n"
                    "ЦЕЛЬ: Краткий факт (60-80 слов). Включите:\n"

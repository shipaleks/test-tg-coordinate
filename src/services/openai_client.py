    ...
    async def get_nearby_fact(self, lat: float, lon: float) -> str:
        ...
        try:
            ...
            user_prompt = (
                ...
                "ВАЖНО: Создайте ПОДРОБНЫЙ и РАЗВЕРНУТЫЙ факт (минимум 150-200 слов). Включите:\n"
                ...
                "- Малоизвестные, но увлекательные подробности\n\n"
                "Финальный ответ в формате:\n"
                "Локация: [Конкретное название места]\n"
                "Интересный факт: [Развернутый, детальный и увлекательный факт с историческими подробностями, "
                "датами, именами и интересными деталями. Минимум 150-200 слов.]"
            )
            ...
            try:
                response = await self.client.chat.completions.create(
                    ...
                    max_completion_tokens=5000,  # Increased for longer, more detailed facts
                )
